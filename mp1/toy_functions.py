...
def toy_fn_1(arg1, arg2):
    ...
    val = tf.pow(arg1, 3) + 4 * tf.pow(arg2, 2) - 10 * arg1
    return val
...
def toy_fn_2(arg1, arg2):
    ...
    '''
    # Input your code here
    val = tf.reduce_sum(arg1, axis=1) - tf.reduce_max(arg2)
    return val
...
def toy_fn_3(arg1, arg2):
    ...
    '''
    # Input your code here
    arg1 = tf.reshape(arg1, [-1, 1])
    arg2 = tf.reshape(arg2, [-1, 1])
    val = tf.reshape(tf.concat([arg1, arg2], axis=1), shape=[1, -1])
    return val
